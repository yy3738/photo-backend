...
(2001, '管理员', 'admin', 1, 1, '系统管理员，拥有全部权限'),
(2002, '摄影师', 'photographer', 2, 1, '可上传作品、管理作品、审批授权'),
(2003, '买家', 'buyer', 3, 1, '可浏览、购买作品、申请授权');
...
-- 一级目录
(3001, '仪表盘',     0,    'dir',    '/dashboard',    '',                  'Dashboard', 1, 1),
(3002, '作品管理',   0,    'dir',    '/photo',        '',                  'Picture',   2, 1),
(3003, '用户管理',   0,    'dir',    '/user',         '',                  'User',      3, 1),
(3004, '授权管理',   0,    'dir',    '/license',      '',                  'Key',       4, 1),
(3005, '系统设置',   0,    'dir',    '/system',       '',                  'Setting',   5, 1),
-- 二级菜单
(3101, '数据概览',   3001, 'menu',   '/dashboard/overview',  'dashboard:view',    '', 1, 1),
(3201, '作品审核',   3002, 'menu',   '/photo/review',        'photo:review',      '', 1, 1),
(3202, '作品列表',   3002, 'menu',   '/photo/list',          'photo:list',        '', 2, 1),
(3301, '用户列表',   3003, 'menu',   '/user/list',           'user:list',         '', 1, 1),
(3401, '授权审核',   3004, 'menu',   '/license/review',      'license:review',    '', 1, 1),
(3501, '分类管理',   3005, 'menu',   '/system/category',     'category:list',     '', 1, 1),
(3502, '标签管理',   3005, 'menu',   '/system/tag',          'tag:list',          '', 2, 1),
-- 三级按钮
(3211, '审核通过',   3201, 'button', '',  'photo:review:approve',  '', 1, 1),
(3212, '审核拒绝',   3201, 'button', '',  'photo:review:reject',   '', 2, 1),
(3311, '封禁用户',   3301, 'button', '',  'user:ban',              '', 1, 1),
(3312, '积分充值',   3301, 'button', '',  'user:recharge',         '', 2, 1),
(3411, '授权通过',   3401, 'button', '',  'license:review:approve','', 1, 1),
(3412, '授权拒绝',   3401, 'button', '',  'license:review:reject', '', 2, 1);

-- -----------------------------------------------------------
-- 4. 角色-菜单关联（admin 拥有全部，photographer/buyer 无后台权限）
-- -----------------------------------------------------------
INSERT INTO t_sys_role_menu (id, role_id, menu_id) VALUES
(4001, 2001, 3001), (4002, 2001, 3002), (4003, 2001, 3003),
(4004, 2001, 3004), (4005, 2001, 3005), (4006, 2001, 3101),
(4007, 2001, 3201), (4008, 2001, 3202), (4009, 2001, 3301),
(4010, 2001, 3401), (4011, 2001, 3501), (4012, 2001, 3502),
(4013, 2001, 3211), (4014, 2001, 3212), (4015, 2001, 3311),
(4016, 2001, 3312), (4017, 2001, 3411), (4018, 2001, 3412);

-- -----------------------------------------------------------
-- 5. 用户（1 管理员 + 3 摄影师 + 4 买家）
-- -----------------------------------------------------------
INSERT INTO t_sys_user (id, openid, nickname, avatar, role, points, is_banned, org_id) VALUES
-- 管理员
(10001, 'ox_admin_001',       '平台管理员',   'https://oss.example.com/avatar/admin.jpg',       'admin',        0,     0, 1001),
-- 摄影师
(10002, 'ox_photographer_001','风光摄影-张伟', 'https://oss.example.com/avatar/zhang.jpg',       'photographer', 8500,  0, 1003),
(10003, 'ox_photographer_002','人像摄影-李娜', 'https://oss.example.com/avatar/lina.jpg',        'photographer', 12600, 0, 1003),
(10004, 'ox_photographer_003','纪实摄影-王磊', 'https://oss.example.com/avatar/wanglei.jpg',     'photographer', 3200,  0, 1003),
-- 买家
(10005, 'ox_buyer_001',       '设计师小陈',   'https://oss.example.com/avatar/chen.jpg',        'buyer',        5000,  0, NULL),
(10006, 'ox_buyer_002',       '编辑部小刘',   'https://oss.example.com/avatar/liu.jpg',         'buyer',        2300,  0, NULL),
(10007, 'ox_buyer_003',       '自媒体老赵',   'https://oss.example.com/avatar/zhao.jpg',        'buyer',        800,   0, NULL),
(10008, 'ox_buyer_004',       '学生小林',     'https://oss.example.com/avatar/lin.jpg',         'buyer',        150,   1, NULL);
